      ...
      <Container>
        <Row>
          <Col md={4}>
            ...
            <p>
              {t(
                "Notre mission est de fournir à nos clients les meilleurs produits tout en offrant un service client exceptionnel. Nous croyons en l'importance de la satisfaction du client et nous travaillons sans relâche pour dépasser leurs attentes."
              )}
            </p>
          </Col>
          <Col md={4}>
