      ...
      <div className='container'>
        {successMsg ? (
          <div className='bg-white rounded-md shadow-md p-8'>
            <p className='text-green-500 font-medium text-center mb-4'>{successMsg}</p>
            <Link href='/SigIn'>{t('signup.loginHere')}</Link>
          </div>
        ) : (
          <form className='bg-white rounded-md shadow-md p-8' onSubmit={handleSignUp}>
            <h1 className='text-2xl md:text-3xl font-semibold mb-4 text-center'>{t('signup.title')}</h1>
            <div className='mb-4'>
              ...
              />
              {errClientName && <p className='text-red-500 text-xs italic'>{errClientName}</p>}
            </div>
            <div className='mb-4'>
            ...
            <p className='mt-4 text-center'>
              ...
              <Link href='/SigIn' className='text-purple-700 hover:text-purple-900'>
                {t('signup.loginHere')}
              </Link>
            </p>
          </form>
