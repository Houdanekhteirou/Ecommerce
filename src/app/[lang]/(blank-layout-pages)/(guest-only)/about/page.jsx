      ...
      <Row className='about-us-section'>
        <Col>
          ...
          <ul dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
            <li>
              <strong>{t('quality')}</strong>: {t('quality_text')}
            </li>
            <li>
              <strong>{t('innovation')}</strong>: {t('innovation_text')}
            </li>
            <li>
              <strong>{t('service')}</strong>: {t('service_text')}
            </li>
            <li>
              <strong>{t('integrity')}</strong>: {t('integrity_text')}
            </li>
          </ul>
        </Col>
      </Row>
