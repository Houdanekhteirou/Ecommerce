    ...
    <>
      <div className='mb-3'>
        <label className='form-label'>
          <FontAwesomeIcon icon={faList} /> {t('categories')}
        </label>
      ...
      <div className='mb-3'>
        <label className='form-label'>
          <FontAwesomeIcon icon={faTag} /> {t('select_brand')}
        </label>
      ...
      <div className='mb-3'>
        <label className='form-label'>
          <FontAwesomeIcon icon={faRulerCombined} /> {t('select_size')}
        </label>
        <select
          className='form-select'
          value={filters.size}
          onChange={handleSizeSelect}
          disabled={!filters.category || !filters.brand}
        >
