...
import { Container, Row, Col, Card, Image, Button, Modal, Form, Alert, Spinner, Pagination } from 'react-bootstrap'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'

import { faPlus, faMinus, faTrash } from '@fortawesome/free-solid-svg-icons'

import { getUserId, getlang } from '../Account/userStorageService'
...
const Cart = ({ updateCartCount }) => {
  ...
  const wilayas = [
    {
      name: t('wilaya1'),
      moughataas: [t('wilaya1mougha1'), t('wilaya1mougha2'), t('wilaya1mougha3')]
    },
    {
      name: t('wilaya2'),
      moughataas: [t('wilaya2mougha1'), t('wilaya2mougha2'), t('wilaya2mougha3')]
    },
    {
      name: t('wilaya3'),
      moughataas: [t('wilaya3mougha1'), t('wilaya3mougha2'), t('wilaya3mougha3')]
    }
  ]
  ...
  if (!userId) {
    router.push('/SigIn', { state: { message: t('login_redirect_message') } })
  ...
  return (
    <Container style={{ direction: direction }}>
      <Row>
                      ...
                      <Row className='g-0'>
                        ...
                        <Col md={8}>
                          <Card.Body>
                            ...
                            <Card.Text>
                              {t('products.taille')}: {item.taille}
                            </Card.Text>
                            <Card.Text>
                              {t('en.Price')}: {item.price}
                            </Card.Text>
        ...
        <Col md={4}>{/* ... Your existing code ... */}</Col>
      </Row>
        ...
        <Modal.Body>
          ...
          <Form>
            ...
            <Form.Group controlId='formWilaya'>
              ...
              <Form.Control as='select' name='wilayaa' value={orderData.wilayaa} onChange={handleWilayaChange}>
                <option value=''>{t('en.Select Wilaya')}</option>
                {wilayas.map(wilayaa => (
                  <option key={wilayaa.name} value={wilayaa.name}>
                    {wilayaa.name}
                  </option>
                ))}
              </Form.Control>
            ...
            <Form.Group controlId='formMoughataa'>
              ...
              >
                ...
                {selectedWilaya &&
                  selectedWilaya.moughataas.map(wilaya => (
